...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        ...
        <form
            method="POST"
            action="{{ url('/barang/'.$barang->barang_id) }}"
                ...
                <div class="col-11">
                    ...
                    >
                        ...
                        <option value="{{ $kat->kategori_id }}" 
                            @if($kat->kategori_id == $barang->kategori_id) selected @endif>
                            {{$kat->kategori_nama }}
                        </option>
                        @endforeach
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    <input
                        ...
                        id="barang_kode"
                        name="barang_kode"
                        value="{{ old('barang_kode', $barang->barang_kode) }}"
                        required
                    />
                    @error('barang_kode')
                    <small class="form-text text-danger">{{ $message }}</small>
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    <input
                        ...
                        id="barang_nama"
                        name="barang_nama"
                        value="{{ old('barang_nama', $barang->barang_nama) }}"
                        required
                    />
                    @error('barang_nama')
                    <small class="form-text text-danger">{{ $message }}</small>
